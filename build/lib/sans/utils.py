...
def default_audioldm_config(model_name="audioldm-s-full"):    
    basic_config = {
        ...
        "model": {
            "device": "cuda",
            "target": "sans.pipline.LatentDiffusion",
            "params": {
                ...
                "scale_by_std": True,
                "unet_config": {
                    "target": "sans.latent_diffusion.openaimodel.UNetModel",
                    "params": {
                        "image_size": 64,
                ...
                "first_stage_config": {
                    ...
                    "target": "sans.variational_autoencoder.autoencoder.AutoencoderKL",
                    "params": {
                ...
                "cond_stage_config": {
                    "target": "sans.clap.encoders.CLAPAudioEmbeddingClassifierFreev2",
                    "params": {
                        "key": "waveform",
                        "sampling_rate": 16000,
                        "embed_mode": "audio",
